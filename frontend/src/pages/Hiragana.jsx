...
export default function Hiragana() {
  ...
  useEffect(() => {
    socket.current = new WebSocket(
      `ws://${import.meta.env.VITE_API_DOMAIN}/ws/${roomId}/hiragana-romaji`
    );
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#FFFACD] text-center text-black">
      ...
      {globalReady ? (
        <>
          <h1 className="z-10 bg-white p-5 text-8xl outline outline-4"> {question}</h1>
          <h1 className="pt-8 font-serif text-4xl">Please enter the rōmaji:</h1>
          <h2 className="pb-4 font-serif text-2xl">ローマ字入力してください：</h2>
